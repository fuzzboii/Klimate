...
function visSlett(test) {
  document.getElementsByClassName("slett").value = "Slett";
  // alert(test);
  document.getElementById("tp").innerHTML = n;
  alert(document.getElementsByClassName("slett")[3].value);
